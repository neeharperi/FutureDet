...
parser.add_argument("--rootDirectory", default="/ssd0/nperi/nuScenes")
...
os.system("python ./tools/dist_test.py configs/{architecture}/{configPath} {extractBox} --work_dir {det_dir} --checkpoint {det_dir}/{modelCheckPoint} --forecast {forecast} --tp_pct {tp_pct}".format(architecture=architecture, 
